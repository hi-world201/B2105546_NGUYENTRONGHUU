  ...
  <li class="">
    ...
    >
      ...
      <div class="ms-2 pe-3 me-auto d-flex justify-content-between flex-column">
        ...
        <div class="categories">Danh mục: {{ categoriesString }}</div>
        <div class="price">
          Giá: {{ priceString }}đ | Kho: {{ product.stockQuantity }}
        </div>
      </div>
      <div class="d-flex flex-column">
        <a class="badge bg-light rounded-pill item-edit mt-2" @click="onView()">
...
const categoriesString = computed(() => {
  return props.product.categories.join(', ');
});
