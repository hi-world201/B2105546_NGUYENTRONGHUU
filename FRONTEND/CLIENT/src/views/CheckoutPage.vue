<template>
  <div>
    ...
    <div class="container-md px-5 py-3 page">
      <legend class="form-title">Xác nhận đặt hàng</legend>
      <div class="mb-3 form-group">
        <div class="order-info">
          ...
          <p class="order-date">
            ...
            ></i>
            Đơn hàng dự kiến sẽ được giao vào ngày
            {{ getDateString(Date.now() + 3600000 * 72) }}
          </p>
        </div>
      ...
      <div rowspan="5" class="d-flex justify-content-center align-items-center">
        ...
        <button class="order-btn" @click="onSubmit">Xác nhận đặt hàng</button>
      </div>
    </div>
  </div>
</template>
...
onBeforeMount(async () => {
  ...
  if (!checkOrderValid()) {
    Swal.fire({
      icon: 'error',
      title: 'Thất bại',
      text: 'Thông tin đơn hàng không hợp lệ! Vui lòng thử lại!',
    });
